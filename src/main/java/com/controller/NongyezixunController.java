...
public class NongyezixunController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,NongyezixunEntity nongyezixun, HttpServletRequest request){
        EntityWrapper<NongyezixunEntity> ew = new EntityWrapper<NongyezixunEntity>();
    	PageUtils page = nongyezixunService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, nongyezixun), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		nongyezixun.setClicknum(nongyezixun.getClicknum()+1);
		nongyezixunService.updateById(nongyezixun);
