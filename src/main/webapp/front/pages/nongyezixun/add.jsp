		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="zixunleixing" id="zixunleixing" lay-filter="zixunleixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in zixunleixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">资料来源：</label>
						<div class="layui-input-block">
							<input v-model="detail.ziliaolaiyuan" type="text" name="ziliaolaiyuan" id="ziliaolaiyuan" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																http.request(`option/zixunleixing/zixunleixing`,'get',{},(res)=>{
					vue.zixunleixing = res.data
				});
																								laydate.render({
					elem: '#fabushijian'
				});
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('nongyezixun' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
