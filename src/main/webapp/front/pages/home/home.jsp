...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in nongyeshipinRecommend" v-bind:key="index">
                <a target="_self" :href="'../nongyeshipin/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.shipinfengmian?item.shipinfengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in nongyezixunList" v-bind:key="index">
                <a target="_self" :href="'../nongyezixun/detail.jsp?id='+item.id">
                  <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`nongyeshipin/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.nongyeshipinRecommend = res.data.list;
      });

      http.request(`nongyezixun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.nongyezixunList = res.data.list;
      });
    });
  </script>
</body>
